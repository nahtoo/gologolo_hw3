                                ...
                                <div className="container">
                                    <div className="panel panel-default">
                                        ...
                                        <TextWorkSpace color={this.state.color} fontSize={this.state.fontSize}
                                            ...
                                            padding={this.state.padding} margin={this.state.margin} text={this.state.text}></TextWorkSpace>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="range" className="form-control-range" name="padding" ref={node => {
                                            padding = node;
                                        }} defaultValue={data.logo.padding} onChange={this.handle} onChange={this.handlePaddingChange}/>
                                    </div>
                                    <div className="form-group">
